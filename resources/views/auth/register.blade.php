    ...
    <main class="relative z-10 w-full max-w-[1000px] mx-auto px-gutter py-xl flex flex-col md:flex-row gap-0">
        ...
        <div class="w-full md:w-1/2 bg-surface/90 backdrop-blur-xl border border-primary/30 rounded-xl md:rounded-l-none md:rounded-r-xl p-lg md:p-xl shadow-[0_0_25px_rgba(0,242,255,0.15)] relative overflow-hidden">
            ...
            <div class="flex border-b border-outline-variant mb-xl">
                <a href="{{ route('login') }}" class="flex-1 pb-sm font-label-md text-label-md text-on-surface-variant hover:text-primary transition-all text-center" id="tab-login">LOGIN</a>
                <button class="flex-1 pb-sm font-label-md text-label-md text-primary border-b-2 border-primary transition-all text-center" id="tab-register">REGISTER</button>
            </div>

            <form method="POST" action="{{ route('register') }}" class="space-y-md" id="form-register">
                @csrf
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input class="w-full bg-surface-container-lowest border border-outline-variant rounded-lg py-sm pl-[44px] pr-sm font-body-md text-body-md text-on-surface placeholder:text-outline-variant input-glow transition-all outline-none" id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Enter your full name" required autofocus autocomplete="name" />
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input class="w-full bg-surface-container-lowest border border-outline-variant rounded-lg py-sm pl-[44px] pr-sm font-body-md text-body-md text-on-surface placeholder:text-outline-variant input-glow transition-all outline-none" id="username" type="text" name="username" value="{{ old('username') }}" placeholder="Choose a display name" required autocomplete="username" />
                    </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-xs">
                        <label class="block font-label-md text-label-md text-on-surface-variant" for="reg-email">Email Address</label>
                        <span class="font-label-md text-[10px] text-outline-variant italic">OPTIONAL</span>
                    </div>
                    <div class="relative">
                        <span class="absolute left-sm top-1/2 -translate-y-1/2 material-symbols-outlined text-outline">mail</span>
                        <input class="w-full bg-surface-container-lowest border border-outline-variant rounded-lg py-sm pl-[44px] pr-sm font-body-md text-body-md text-on-surface placeholder:text-outline-variant input-glow transition-all outline-none" id="reg-email" type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email (Opsional)" />
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input class="w-full bg-surface-container-lowest border border-outline-variant rounded-lg py-sm pl-[44px] pr-sm font-body-md text-body-md text-on-surface placeholder:text-outline-variant input-glow transition-all outline-none" id="reg-password" type="password" name="password" placeholder="Create a strong password" required autocomplete="new-password" />
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input class="w-full bg-surface-container-lowest border border-outline-variant rounded-lg py-sm pl-[44px] pr-sm font-body-md text-body-md text-on-surface placeholder:text-outline-variant input-glow transition-all outline-none" id="password_confirmation" type="password" name="password_confirmation" placeholder="Repeat your password" required autocomplete="new-password" />
                    </div>
